...
public class TableMain {
	...
	//			System.out.println("\nARGS : "+ "\n1. "+args[0]+"\n2. "+args[1]+"\n3. "+args[2]+"\n4. "+args[3]+"\n\n");
				...
				HashMap<String, String> configMap = objValidations.GetConnectionString(excelinputPath, dbSheetName);
				String projectID = objValidations.GetProjectID(excelinputPath, dbSheetName);
				//projectID="780107";
				System.out.println("Projectid"+projectID);
				String DBUser = objValidations.GetDBUser(excelinputPath, dbSheetName);
				String DBPassword = objValidations.GetDBPassword(excelinputPath, dbSheetName);
				 inputObj = objValidations.ConstructInputJson(excelDataMap, configMap, masterTestDataPath,
							masterTestDataId, referenceidFolder, excelinputPath, projectID);
